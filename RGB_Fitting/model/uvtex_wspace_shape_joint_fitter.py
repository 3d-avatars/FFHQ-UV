...
class Fitter:
    ...
    def __init__(self,
        ...
        self.coeffs_opt_dict['id'].requires_grad = True
        self.coeffs_opt_dict['exp'].requires_grad = True
        self.coeffs_opt_dict['angle'].requires_grad = True
        self.coeffs_opt_dict['gamma'].requires_grad = True
        self.coeffs_opt_dict['trans'].requires_grad = True
        ...
        self.optimizer = torch.optim.Adam([{
            ...
            "params": self.coeffs_opt_dict['id'],
            "lr": self.initial_lr
        }, {
        ...
        self.initial_lr_list = [
            self.initial_lr * self.tex_lr_scale, self.initial_lr, self.initial_lr, self.initial_lr * self.pose_lr_scale,
            self.initial_lr * self.tex_lr_scale, self.initial_lr * self.pose_lr_scale
        ]
        self.now_step = 0
